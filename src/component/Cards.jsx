        ...
        <div className="md:flex w-full">
            ...
            <div className="md:mt-0 divide-y divide-black text-md">
              ...
              <div id="1">
                <div className="w-full justify-center text-center bg-gray-400 px-4 py-2 font-medium text-black">
                  <span className="">Super Armory </span>
                  <span>@300k Idr</span>
                  <div>
                    <AddCartM title="Super Armory" />
                  </div>
                </div>
                <div className="px-4 pb-4 pt-4 bg-gray-300">
                  <div className="">
                    <div className="w-[300px] ml-11 mb-3">
                      <img src={armory} alt="" />
                    </div>
          ...
          >
            <div className="md:mt-0 divide-y divide-black text-md">
              ...
              <div>
                <div className="w-full justify-center text-center bg-gray-400 px-4 py-2 font-medium text-black">
                  <span className="pr-2">Battle Hardened</span>
                  <span>@800k idr</span>
                  <div>
                    <AddCartM id="2" />
                  </div>
          ...
          >
            <div className="md:mt-0 divide-y divide-black text-md">
              ...
              <div>
                <div className="w-full justify-center text-center bg-gray-400 px-4 py-2 font-medium text-black">
                  <span className="pr-2">Pro Quest+</span>
                  <span>@550k idr</span>
                  <div>
                    <AddCartM id="3" />
                  </div>
          ...
          >
            <div className="md:mt-0 divide-y divide-black text-md">
              ...
              <div>
                <div className="w-full justify-center text-center bg-gray-400 px-4 py-2 font-medium text-black">
                  <span className="pr-2">Side Event CC</span>
                  <span>@200k idr</span>
                  <div>
                    <AddCartM id="4" />
                  </div>
          ...
          >
            <div className="md:mt-0 divide-y divide-black text-md">
              ...
              <div>
                <div className="w-full justify-center text-center bg-gray-400 px-4 py-2 font-medium text-black">
                  <span className="pr-2">Side Event Blitz</span>
                  <span>@200k idr</span>
                  <div>
                    <AddCartM id="5" />
                  </div>
            ...
            <div className="md:mt-0 divide-y divide-black text-md">
              ...
              >
                <div className="md:mt-0 divide-y divide-black text-md">
                  ...
                  <div>
                    <div className="w-full justify-center text-center bg-gray-400 px-4 py-2 font-medium text-black">
                      <span className="pr-2">Side Event MST Sealed</span>
                      <span>@600k idr</span>
                      <div>
                        <AddCartM id="6" />
                      </div>
          ...
          >
            <div className="md:mt-0 divide-y divide-black text-md">
              ...
              <div>
                <div className="w-full justify-center text-center bg-gray-400 px-4 py-2 font-medium text-black">
                  <span className="pr-2">BH:Bali Custom Playmat</span>
                  <span>@300k idr</span>
                  <div>
                    <AddCartM id="7" />
                  </div>
          ...
          >
            <div className="md:mt-0 divide-y divide-black text-md">
              ...
              <div>
                <div className="w-full justify-center text-center bg-gray-400 px-4 py-2 font-medium text-black">
                  <span className="pr-2">BH:Bali Custom Deckcase</span>
                  <span>@300k idr</span>
                  <div>
                    <AddCartM id="8" />
                  </div>
          ...
          >
            <div className="md:mt-0 divide-y divide-black text-md">
              ...
              <div>
                <div className="w-full justify-center text-center bg-gray-400 px-4 py-2 font-medium text-black">
                  <span className="pr-2">
                    BH:Bali Custom Playmat & Deckcase
                  </span>
                  ...
                  <div className="divide-y divide-black">
                    <div>
                      ...
                      <ul className="text-[14pt] list-disc px-8">
                        ...
                        <li>Top ranks : additional FAB Booster Packs</li>
                        <li>
                          Full prize structure will be announced at event start
                        </li>
                      </ul>
                    </div>
                  </div>
        ...
        >
          <div className="md:mt-0 divide-y divide-black text-md pb-2">
            ...
            <div>
              <>
                <div className="flex w-full justify-between text-left bg-gray-400 px-4 py-2 font-medium ">
                  <span className="pt-1">Battle Hardened</span>
                  <span className="ml-96 pl-8 py-1">@800k Idr</span>
                  <div>
                    <AddCart />
                  </div>
                </div>
                <div className="px-4 pb-4 pt-4 bg-gray-300">
                  <div className="">
                    ...
                    <p className="text-[14pt] italic">
                      Decklists are required and will be collected before Round
                      1 begins.
                    </p>
                    <div className="pt-2">
                      <div>
        ...
        >
          <div className="md:mt-0 divide-y divide-black text-md pb-2">
            ...
            <div>
              <>
                <div className="flex w-full justify-between text-left bg-gray-400 px-4 py-2 font-medium ">
                  <span className="pt-1">Pro Quest+</span>

                  <span className="py-1 ml-[500px] pl-[3.2rem]">@550k Idr</span>
                  <div>
                    <AddCart />
                  </div>
                </div>
                <div className="px-4 pb-4 pt-4 bg-gray-300">
                  <div className="">
                    ...
                    <div className="px-4 mt-2 mb-2 flex justify-between">
                      ...
                      <div>
                        <img className="w-[600px] mr-6 mt-4" src={PQ} alt="" />
                      </div>
                    </div>
                    <p className="text-[14pt] italic">
                      Tournament Structure : Swiss rounds based on attendance,
        ...
        >
          <div className="md:mt-0 divide-y divide-black text-md pb-2">
            ...
            <div>
              <>
                <div className="flex w-full justify-between text-left bg-gray-400 px-4 py-2 font-medium ">
                  <span className="pt-1">Side Event Classic Constructed</span>
                  <span className="py-1 ml-[300px] pl-[4.6rem]">@200k Idr</span>
                  <div>
                    <AddCart />
                  </div>
                </div>
        ...
        >
          <div className="md:mt-0 divide-y divide-black text-md pb-2">
            ...
            <div>
              <>
                <div className="flex w-full justify-between text-left bg-gray-400 px-4 py-2 font-medium ">
                  <span className="pt-1">Side Event Blitz Constructed</span>
                  <span className="py-1 ml-[300px] pl-[5.6rem]">@200k Idr</span>
                  <div>
                    <AddCart />
                  </div>
                </div>
        ...
        >
          <div className="md:mt-0 divide-y divide-black text-md pb-2">
            ...
            <div>
              <>
                <div className="flex w-full justify-between text-left bg-gray-400 px-4 py-2 font-medium ">
                  <span className="pt-1">Side Event MST Sealed</span>
                  <span className="py-1 ml-[400px] pl-[3rem]">@600k Idr</span>
                  <div>
                    <AddCart />
                  </div>
                </div>
        ...
        >
          <div className="md:mt-0 divide-y divide-black text-md pb-2">
            ...
            <div>
              <>
                <div className="flex w-full justify-between text-left bg-gray-400 px-4 py-2 font-medium ">
                  <span className="pt-1">BH:Bali Custom Playmat</span>
                  <span className="py-1 ml-[400px] pl-[2.5rem]">@300k Idr</span>
                  <div>
                    <AddCart />
                  </div>
                </div>
        ...
        >
          <div className="md:mt-0 divide-y divide-black text-md pb-2">
            ...
            <div>
              <>
                <div className="flex w-full justify-between text-left bg-gray-400 px-4 py-2 font-medium ">
                  <span className="pt-1">BH:Bali Custom DeckCase</span>
                  <span className="py-1 ml-[400px] pl-[2.5rem]">@300k Idr</span>
                  <div>
                    <AddCart />
                  </div>
            ...
            <div>
              <>
                <div className="flex w-full justify-between text-left bg-gray-400 px-4 py-2 font-medium ">
                  ...
                  <span className="py-1 ml-[300px] pl-[2.5rem]">@550k Idr</span>
                  <div>
                    <AddCart />
                  </div>
                </div>
